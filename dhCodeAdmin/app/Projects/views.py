...
def TableBuilder(result):
    ...
    for proyect in result:
        ...
        modalEdit+='        <h6 class="card-header">Proyecto N°: <input required name="id" id="input-id-'+str(proyect.id)+'"type="text" readonly class="form-control" value="'+str(proyect.id)+'"></h6>'
        modalEdit+='        <h6 class="card-header">Nombre del Proyecto: <input required name="proyect_name" id="input-proyect_name-'+str(proyect.id)+'"type="text" class="form-control" value="'+proyect.proyect_name+'"></h6>'
        modalEdit+='        <h6 class="card-header">Fecha de Inicio: <input required name="begin_date"  id="input-begin_date-'+str(proyect.id)+'" type="date" class="form-control"value="'+str(proyect.begin_date)+'"></h6>'
        modalEdit+='        <h6 class="card-header">Fecha de Termino: <input required name="end_date" id="input-end_date-'+str(proyect.id)+'" type="date" class="form-control" value="'+str(proyect.end_date)+'"></h6>'
        modalEdit+='        <h6 class="card-header">Nombre de Lider: <input required name="manager_name" id="input-manager_name-'+str(proyect.id)+'" type="text" class="form-control"value="'+proyect.manager_name+'" ></h6>'
        modalEdit+='        <h6 class="card-header">Nombre de Cliente: <input required name="client_name" id="input-client_name-'+str(proyect.id)+'" type="text" class="form-control" value="'+proyect.client_name+'"></h6>'
        modalEdit+='             </div>'
        modalEdit+='      </div>'
