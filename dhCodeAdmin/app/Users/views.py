...
def TableBuilder(result):
    ...
    alt_table+='<thead><tr><th>Folio</th><th>Nombre de Usuario</th><th>Privilegio</th>'
    alt_table+='<th></th></tr></thead><tbody>'
    downtable='</tbody>'
    downtable+='<tfoot>'
    downtable+='<tr>'
    downtable+='<th>Folio</th>'
    downtable+='<th>Nombre de Usuario</th>'
    downtable+='<th>Privilegio</th>'
    ...
    for emp in result:
    	admin = "Básico"
        content+='<tr><td>'+username.nombre+'</td>'
        content+='<td>'+admin+'</td>'
